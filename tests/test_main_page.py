...
class TestMainPageFaq:
    @allure.title('Проверяется содержимое раздела"Вопросы о важном"')
    @allure.description('Проверяется, что при нажатии на каждую иконку раскрытия в разделе появляется соответствующий ожидаемый текст')
